 ...
 * @author Anabe
 */
public class ControladorListadoDepartamentoyEmpleados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String codigo="60";
            List<Departamento> ListaGeneralDepartamentos=new DAOperaciones().listadoDepartamentoyEmpleados(codigo,SessionBuilder);
