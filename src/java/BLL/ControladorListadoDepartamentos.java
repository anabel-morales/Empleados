 ...
 * @author Anabe
 */
public class ControladorListadoDepartamentos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Departamento> ListaGeneralDepartamentos=new DAOperaciones().getListadoGeneralDepartamentos(SessionBuilder);
