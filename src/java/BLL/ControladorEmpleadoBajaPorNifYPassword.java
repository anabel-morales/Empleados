 ...
 * @author Anabe
 */
public class ControladorEmpleadoBajaPorNifYPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nif = "06290540V";
            String password=Hash.sha1("Anabel");
            try {
                new DAOperaciones().borrarEmpleado(nif,password, SessionBuilder);
