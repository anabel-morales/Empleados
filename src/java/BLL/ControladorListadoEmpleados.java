 ...
 * @author Anabe
 */
public class ControladorListadoEmpleados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Empleado> ListadoGeneralEmpleados = new DAOperaciones().getListadoGeneralEmpleados(SessionBuilder);
